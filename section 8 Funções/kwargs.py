...
poderiamos chamar este par^metro de **xix, mas por convenção chamamos de **kwargs
...
cores_favoritas(marcos='verde', julia='amarelo', bob='azul', bilu='preto')
...
def cumprimento_especial(**kwargs):
    if 'geek' in kwargs and kwargs['geek'] == 'Python':
        return 'Você recebeu cumprimento Pythônico Geek!'
    elif 'geek' in kwargs:
...
# Nasnossas funções podemos ter (NESTA ORDEM):
...
minha_funcao(18, 'Felicity', 4, 3, 5, 6, solteiro=True)
