...
A funçaõ do Pickle é realizar o seguinte processo:

Objeto Python -> Objeto Python
...
with open('anímais.pickle', 'wb') as arquivo:
...
with open('anímais.pickle', 'rb') as arquivo:
