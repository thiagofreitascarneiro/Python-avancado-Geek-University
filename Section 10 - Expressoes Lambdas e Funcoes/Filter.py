...
# OBS: Os dados após serem utilizados assim como na função map, após serem utilizados
# os dados de filter() eles são excluidos da memória.

print(f'Novamente: {list(res)}')

print(paises)

# None é um tipo vazio
...
res = filter(lambda pais: paises != '', paises)
