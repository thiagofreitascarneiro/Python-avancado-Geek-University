...
# OBS: Ao abrir um arquivo para leitura, não podemos realizar a ecrita nele. Apenas ler.
...
caso ele já exista, o anterior será apagado e um novo será criado. Dessa forma, todo o
...
arquivo.write('Um texto qualqquer.\n')
